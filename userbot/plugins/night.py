...
DEFAULTUSER = (
    str(ALIVE_NAME) if ALIVE_NAME else "Tornado User"
)
    ...
    if ".night" not in current_message and "yes" in USER_night:  # pylint:disable=E0602
        try:
            ...
            await borg.send_message(  # pylint:disable=E0602
                ...
                + "report in [TornadoBot](t.me/Tornado_Chit_Chat)\n\n `{}`".format(str(e)),
...
async def _(event):
    ...
    if not USER_night:  # pylint:disable=E0602
        ...
        try:
            await borg.send_message(  # pylint:disable=E0602
                Config.TORNADOBOT_LOGGER, f"My BOss Wants So Sleep"  # pylint:disable=E0602
            )
        except Exception as e:  # pylint:disable=C0103,W0703
