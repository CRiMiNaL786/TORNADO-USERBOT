...
@tornadobot.on(admin_cmd(pattern=r"unpack", outgoing=True))
@tornadobot.on(sudo_cmd(pattern=r"unpack"))
async def _(event):
...
@tornadobot.on(admin_cmd(pattern="repack ?(.*)", outgoing=True))
@tornadobot.on(sudo_cmd(pattern="repack ?(.*)", allow_sudo=True))
async def _(event):
