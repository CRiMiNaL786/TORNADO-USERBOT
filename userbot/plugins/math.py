...
@tornadobot.on(admin_cmd(pattern="sin ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="sin ?(.*)", allow_sudo=True))
...
@tornadobot.on(admin_cmd(pattern="cos ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="cos ?(.*)", allow_sudo=True))
...
@tornadobot.on(admin_cmd(pattern="tan ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="tan ?(.*)", allow_sudo=True))
...
@tornadobot.on(admin_cmd(pattern="cosec ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="cosec ?(.*)", allow_sudo=True))
...
@tornadobot.on(admin_cmd(pattern="sec ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="sec ?(.*)", allow_sudo=True))
...
@tornadobot.on(admin_cmd(pattern="cot ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="cot ?(.*)", allow_sudo=True))
...
@tornadobot.on(admin_cmd(pattern="square ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="square ?(.*)", allow_sudo=True))
...
@tornadobot.on(admin_cmd(pattern="cube ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="cube ?(.*)", allow_sudo=True))
