...
from tornadobot.utils import admin_cmd, load_module
from var import Var
...
CmdHelp("extra_py").add_command(
  'extdl', None, 'Installs all plugins from the channal which id is in TORNADOBOT_LOGGER variable'
).add_command(
