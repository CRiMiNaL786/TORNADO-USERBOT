...
async def _(event):
    ...
    await edit_or_reply(event, "tornadoo")
    animation_chars = [
        "Indian Flag",
...
@bot.on(admin_cmd(pattern="yo$", outgoing=True))
...
async def _(event):
    ...
    animation_chars = [
        ...
        "`Call Connected.`",
        "`Secretary: tornadoo This is Raj Bhawan. Who is this?`",
        f"`Me: tornadoo this is` `{DEFAULUSER}` .Please connect me to Prime Minister",
        "`User Authorised.`",
        "`Calling`  `At +9189*#*#*#56`",
        "`Private  Call Connected...`",
        "`Me: tornadoo Sir, How are you!!`",
...
async def _(event):
    ...
    if event.reply_to_msg_id:
        ...
        if idd == 1212368262:
            await event.edit(
                "This is My Master\n**How dare you trying to tell me to kill master nigger!**\n\n__Your account is on hold! Pay 99$ to my master__ [Himanshu](https://t.me/THETORNADOTEAM) __to release your account__😏"
            )
        else:
