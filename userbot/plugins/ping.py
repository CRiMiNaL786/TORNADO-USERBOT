...
async def _(event):
    ...
    ms = (end - start).microseconds / 1000
    if TORNADO_IMG:
        tornado_caption = f"__**〘 ♕ ᑭσɳց! ♕ 〙__**\n\n   ⚘ {ms}\n   ⚘ __**𝙼𝚢**__ __**𝙼𝚊𝚜𝚝𝚎𝚛**__⟿[{DEFAULTUSER}](tg://user?id={thetornadoteam})"
        await event.client.send_file(
            event.chat_id, TORNADO_IMG, caption=tornado_caption
        )
        await event.delete()
