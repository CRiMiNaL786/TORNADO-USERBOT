...
async def carbon_api(e):
    ...
    tornado = await edit_or_reply(e, "`Carbonizing...\n25%`")
    ...
    await tornado.edit("`Processing..\n75%`")
    # Waiting for downloading
    await asyncio.sleep(2)
    await tornado.edit("`Done Dana Done...\n100%`")
    file = "./carbon.png"
    await tornado.edit("`Uploading..`")
    await e.client.send_file(
        e.chat_id,
        file,
        caption="Here's your carbon, \n Carbonised by TornadoBot",
        force_document=True,
...
async def carbon_api(e):
    if e.fwd_from:
        return
    tornado = await edit_or_reply(e, "`Processing....`")
    CARBON = "https://carbon.now.sh/?l={lang}&code={code}"
    textx = await e.get_reply_message()
    pcode = e.text
    if pcode[5:]:
    ...
    pcode = deEmojify(pcode)
    code = quote_plus(pcode)  # Converting to urlencoded
    await tornado.edit("`Meking Carbon...`\n`25%`")
    url = CARBON.format(code=code, lang=CARBONLANG)
    chrome_options = Options()
    chrome_options.add_argument("--headless")
...
async def carbon_api(e):
    ...
    await tornado.edit("🔳🔳🔳🔳🔳")
    file = "./carbon.png"
    await tornado.edit("☣️Karbon1 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
        force_document=True,
    ...
    os.remove("./carbon.png")
    # Removing carbon.png after uploading
    await tornado.delete()  # Deleting msg
...
async def carbon_api(e):
    ...
    await tornado.edit("🔘🔘🔘🔘🔘")
    file = "./carbon.png"
    await tornado.edit("☣️Karbon2 Completed, Uploading Karbon☣️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await tornado.edit("🔵🔵🔵🔵🔵")
    file = "./carbon.png"
    await tornado.edit("☣️Karbon3 Completed, Uploading Karbon⬆️")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await tornado.edit("🌝🌝🌝🌝🌝")
    file = "./carbon.png"
    await tornado.edit("✅Karbon4 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await tornado.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await tornado.edit("✅RGB Karbon 2.0 Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
...
async def carbon_api(e):
    ...
    await tornado.edit("⬛⬛⬛⬛⬛")
    file = "./carbon.png"
    await tornado.edit("✅RGB Karbon Completed, Uploading Karbon✅")
    await e.client.send_file(
        e.chat_id,
        file,
        caption=f"Here's your karbonrgb",
