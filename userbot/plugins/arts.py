...
@bot.on(admin_cmd(pattern=r"tornadoo$"))
@bot.on(sudo_cmd(pattern="tornadoo$", allow_sudo=True))
async def bluedeviltornadoo(tornadoo):
    if tornadoo.fwd_from:
        return
    await edit_or_reply(tornadoo, K)
