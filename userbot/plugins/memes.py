...
async def source(e):
    if not e.text[0].isalpha() and e.text[0] not in ("/", "#", "@", "!"):
        await edit_or_reply(e, "Click [here](https://github.com/TornadoBotOP/TornadoBot) to open this 🔥**Lit AF!!**🔥 __TORNADOBOT__ Repo.. Join channel :- @TornadoBot_Support")
...
async def smrk(smk):
    ...
    if message == "dele":
        await edit_or_reply(smk, message + "te the tornado" + "ツ")
