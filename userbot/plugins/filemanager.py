...
async def _(event):
    ...
    process = await asyncio.create_subprocess_stornado(
        cmd, stdout=asyncio.subprocess.PIPE, stderr=asyncio.subprocess.PIPE
    )
    OUTPUT = f"**Files in [TornadoBot](t.me/TornadoBot_Support) DOWNLOADS Folder:**\n"
...
CmdHelp("filemanager").add_command(
  'ls_local', None, 'Gives the list of downloaded medias in your tornadobot server.'
).add_command(
  'ls_root', None, 'Gives the list of all files in root directory of tornadobot repo.'
).add_command(
  'ls_saved', None, 'Gives the list of all files in Saved directory of your tornadobot server'
).add_command(
