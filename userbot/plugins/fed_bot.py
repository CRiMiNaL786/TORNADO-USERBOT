...
from tornadobot.Config import Config
from tornadobot.plugins.sql_helper.fban_sql import (
    add_channel,
    get_all_channels,
    in_channels,
    rm_channel,
...
bot = "@MissRose_bot"
tornado_logo = "./THETORNADOTEAM/tornadobot_logo.jpg"
# Keep all credits pls
# madewith great effort by @HeisenbergTheDanger
# modified by @kraken_the_badass for fbans


@tornadobot.on(admin_cmd(pattern="fban ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="fban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
...
@tornadobot.on(admin_cmd(pattern="unfban ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="unfban ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    mssg = await eor(event, "`...`")
...
@tornadobot.on(admin_cmd(pattern=r"fadd ?(.*)"))
@tornadobot.on(sudo_cmd(pattern=r"fadd ?(.*)", allow_sudo=True))
...
@tornadobot.on(admin_cmd(pattern=r"fremove ?(.*)"))
@tornadobot.on(sudo_cmd(pattern=r"fremove ?(.*)", allow_sudo=True))
...
@tornadobot.on(admin_cmd(pattern="fgroups"))
@tornadobot.on(sudo_cmd(pattern="fgroups", allow_sudo=True))
...
@tornadobot.on(admin_cmd(pattern="fsearch ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="fsearch ?(.*)", allow_sudo=True))
...
@tornadobot.on(admin_cmd(pattern="newfed ?(.*)", outgoing=True))
@tornadobot.on(sudo_cmd(pattern="newfed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    ...
    async with borg.conversation(chat) as conv:
        try:
            ...
            await event.client.send_message(chat, f"/newfed {tornado_input}")
...
@tornadobot.on(admin_cmd(pattern="renamefed ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="renamefed ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return 
    tornado_input = event.pattern_match.group(1)
    ...
    async with event.client.conversation(chat) as conv:
          try:     
              ...
              await event.client.send_message(chat, f"/renamefed {tornado_input}")
              response = await response 
          except YouBlockedUserError: 
...
@tornadobot.on(admin_cmd(pattern="fstat ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="fstat ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    tornado = await event.edit("`Collecting fstat....`")
    thumb = tornado_logo
    if event.reply_to_msg_id:
        previous_message = await event.get_reply_message()
        ...
        async with borg.conversation(bot) as conv:
            try:
                ...
                if "Looks like" in massive.text:
                    ...
                    massive = await conv.get_response()
                    await tornadobot.send_file(
                        event.chat_id,
                        massive,
                        thumb=thumb,
                        caption=f"List of feds {user} has been banned in.\n\n**⚡ [Collected using TornadoBot](t.me/TornadoBot_Support) ⚡**",
                    )
                else:
                    await borg.send_message(event.chat_id, massive.text)
                await event.delete()
            except YouBlockedUserError:
                await tornado.edit("`Please Unblock` @MissRose_Bot")


@tornadobot.on(admin_cmd(pattern="fedinfo ?(.*)"))
@tornadobot.on(sudo_cmd(pattern="fedinfo ?(.*)", allow_sudo=True))
async def _(event):
    if event.fwd_from:
        return
    tornado = await eor(event, "`Fetching fed info.... please wait`")
    lavde = event.pattern_match.group(1)
    async with borg.conversation(bot) as conv:
        try:
            await conv.send_message("/start")
            ...
            massive = await conv.get_response()
            await tornado.edit(massive.text + "\n\n**LEGENDARY_AF_TORNADOBOT**")
        except YouBlockedUserError:
            await tornado.edit("`Please Unblock` @MissRose_Bot")
