...
if ENV:
    ...
    class Config(object):
        ...
        TELEGRAPH_SHORT_NAME = os.environ.get("TELEGRAPH_SHORT_NAME", "TornadoBot")
       ...
       # PLUGIN_CHANNEL = int(os.environ.get("PLUGIN_CHANNEL", None))
        UPSTREAM_REPO = os.environ.get(
            "UPSTREAM_REPO", "https://github.com/TornadoBotOP/TornadoBot"
        )
        ...
        EXTRA_TORNADOBOT = os.environ.get("EXTRA_TORNADOBOT", -1001221881562)
        PM_DATA = os.environ.get("PM_DATA", "ENABLE")
        TORNADOBOT_LOGGER = int(os.environ.get("TORNADOBOT_LOGGER", None))
